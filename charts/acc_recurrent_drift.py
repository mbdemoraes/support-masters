...
plt.plot([10000,20000,30000,40000,50000,60000,70000,80000,90000,100000], [71.28,71.04,68.98,69.25,69.46,64.21,64.10,64.85,63.69,63.69],  marker="v", color='#4db82c')
...
plt.axvline(x=30000, ymax=1, color='#e52845', ls='--', linewidth=2)
